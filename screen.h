...
// screen constants
#define SCRSTARTX      3      // Inicial e final das posições da tela para o jogo
#define SCRENDX        75     // Área que pode ser desenhada
#define SCRSTARTY      1
#define SCRENDY        23     
#define MINX           1      // posição horizontal mínima da tela
#define MINY           1      // posição vertical mínima da tela
#define MAXX           80     // posição horizontal máxima da tela
#define MAXY           24     // posição vertical máxima da tela
